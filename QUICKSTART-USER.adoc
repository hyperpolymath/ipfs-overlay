...
// Replace ipfs-overlay, Ipfs Overlay — See README.adoc for details., just run, Ipfs Overlay started successfully. with actuals
= ipfs-overlay — Quick Start for Users
:toc:
:toclevels: 2

== What is ipfs-overlay?

Ipfs Overlay — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./ipfs-overlay-portable
----
...
[source]
----
Ipfs Overlay started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/ipfs-overlay/wiki
