...
git clone <https://github.com/hyperpolymath/ipfs-overlay.git> cd
ipfs-overlay
...
toolbox create ipfs-overlay-dev toolbox enter ipfs-overlay-dev \#
...
ipfs-overlay/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/ipfs-overlay/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/ipfs-overlay/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/ipfs-overlay/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/ipfs-overlay/labels/perimeter-3) — Community sandbox scope
